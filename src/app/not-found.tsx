        ...
        <div className="h-screen w-full bg-[#1C2434] text-[#83CE71] content-center pt-24 text-center">
          ...
          <div>
            ...
            <div className="m-auto text-center p-4">
              ...
              <a
                href="/"
                className="inline-flex items-center px-3 py-2  text-xl  text-center hover:text-[black] hover:bg-[#83CE71] rounded-lg bg-[#83CE71] text-white hover:text-bold focus:ring-4 focus:outline-none focus:ring-blue-300 "
              >
                Back to Home
                <svg
